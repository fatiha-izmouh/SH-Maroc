...
<div class="body">
    ...
    <div class="container">
        <div class="search-box">
            <form class="form-inline" method="GET" action="{{ route('actualites.cf') }}">
    ...
    <div id="cards-container">
        @forelse ($actualitesCF as $actualite)
            <a href="{{ route('actualite.show', $actualite->id) }}" class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="card-text">{{ \Illuminate\Support\Str::limit($actualite->description, 130, '...') }}</p>
                    <div class="date-lieu">
